...
public class AutoLemmingCatabombe extends Automate implements Constantes {

	public AutoLemmingCatabombe(int nbTransitions) {
		
		super(nbTransitions, lemmingCatabombe);
