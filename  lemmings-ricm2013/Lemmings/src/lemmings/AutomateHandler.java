...
public class AutomateHandler extends DefaultHandler{
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes)
		...
		if(qName.equals("open")){
			...
			try{
				...
				automate.setNom(nom);
				automate.setIdentifiant(Automate.nomVersIdentifiant(nom));
			}catch(Exception e){
	...
	public void endElement(String uri, String localName, String qName)
		...
		if(qName.equals("open")){
			...
			Jeu.listeAutomates.add(automate);
			automate = null;
			inAutomate = false;
		}else if(qName.equals("transition")){
	...
	public void endDocument() throws SAXException {
		...
		for(Automate a : Jeu.listeAutomates){
			System.out.println(a);
		}
	}

	// test
	public static void initAutomates(String fichierXML){
		try{
